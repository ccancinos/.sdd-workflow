...
- Skill discovery indexes `name`, `description` trigger text, scope, and exact `SKILL.md` path.
- Agents read the full skill before work; discovery does not summarize or rewrite it.
