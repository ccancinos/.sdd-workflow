...
- Count authored additions plus deletions for the `>400` threshold. Exclude generated goldens from that authored count.
...
- When fixing review feedback, group atomic work units inside a single correction; work-unit count never creates a larger scope than the feedback requires.
